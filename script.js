document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateCountdown() {
    ...
    if (now < firstCountdownDate) {
      ...
      initialMessage.innerText = "¡Estoy re feliz! 😎 Algo súper especial viene en camino, pero primero mirá esta cuenta regresiva hasta las 20:00. ¡Preparate para lo que se viene!";
      ...
      initialMessage.innerText = "Jajajaja te la creiste. ¡Ya estamos más cerca! 😏 Toca esperar un poco a que termine de configurar todo correctamente.";
    } else {
